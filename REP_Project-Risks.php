...
<title><?php echo "[".$_GET['Project_ID']."]"; ?> Project Risk Report <?php echo "(".$Heading_Index.")" ?> <?php echo date("Y-m-d"); ?></title>
</head>
<body onload="">
...
$Display_Array['Table_Major_Heading'] = "PROJECT RISK(S) REPORT";
