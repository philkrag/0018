...
$Display_Array['Table_Major_Heading'] = "SITE";
...
$Display_Array = null;
$Display_Array['ID'] = $Item_ID;
$Display_Array['Table_Major_Heading'] = "MAP(S)";
$Display_Array['Table_Minor_Heading'] = "...";
$Display_Array['Display_Items'] = array("ID", "(P):Map_Photos", "Description");
$Display_Array['Column_Width'] = array("50px", "100px", "*");
$Display_Array['Item_Links'] = "REC-DTL_Maps.php";
$Display_Array['New_Link_Reference'] = "Site ID";

$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_maps` ";
$Display_Array['MySQL_Filter'] = "WHERE `Site ID` = ".$Item_ID." AND (`Deleted Date` IS NULL OR `Deleted Date` = '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = ""; 
