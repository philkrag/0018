...
<title><?php echo "[".$_GET['ID']."]"; ?> Storage Report <?php echo date("Y-m-d"); ?></title>
</head>
<body onload="">
...
$Display_Array['Display_Items'] = array("ID", "Equipment Name", "Part", "Serial Number");
$Display_Array['Column_Width'] = array("50px", "*", "150px", "250px");
$Display_Array['Item_Links'] = "";
...
$Display_Array['Table_Minor_Heading'] = "...";
$Display_Array['Display_Items'] = array("ID", "Description", "", "Manufacturer", "Manufacturer Part #", "Serial #");
$Display_Array['Column_Width'] = array("50px", "*", "150px", "250px", "150px", "250px");
...
$Display_Array['Column_Width'] = array("50px", "100px", "*", "150px", "250px", "150px", "250px");
