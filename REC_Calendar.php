...
// 2021-05-07 	|| Phillip Kraguljac 		|| v1.5. (Created)
...
for ($Week_Indexer = 1; $Week_Indexer <= 6; $Week_Indexer++) {
...
$Display_Array['MySQL_Filter'] = "WHERE `Required Completion Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
...
$Display_Array['MySQL_Filter'] = "WHERE `Required Decommission Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = "";
$Display_Array['MySQL_Limit'] = "";
$Display_Array['MySQL_Offset'] = "";
...
$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_tasks` ";
$Display_Array['MySQL_Filter'] = "WHERE `Identified Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = "";
$Display_Array['MySQL_Limit'] = "";
$Display_Array['MySQL_Offset'] = "";
...
$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_tasks` ";
$Display_Array['MySQL_Filter'] = "WHERE `Planned Work Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = "";
$Display_Array['MySQL_Limit'] = "";
$Display_Array['MySQL_Offset'] = "";
...
$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_equipment-change` ";
$Display_Array['MySQL_Filter'] = "WHERE `Planned Decommission Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = "";
$Display_Array['MySQL_Limit'] = "";
$Display_Array['MySQL_Offset'] = "";
...
$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_tasks` ";
$Display_Array['MySQL_Filter'] = "WHERE `Actual Completed Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = "";
$Display_Array['MySQL_Limit'] = "";
$Display_Array['MySQL_Offset'] = "";
...
$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_equipment-change` ";
$Display_Array['MySQL_Filter'] = "WHERE `Actual Commission Date` = '".date("Y-m-d ", mktime(0, 0, 0, $Review_Month, $Day_Counter, $Review_Year))."' AND (`Deleted Date` IS NULL OR `Deleted Date` > '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = "";
$Display_Array['MySQL_Limit'] = "";
$Display_Array['MySQL_Offset'] = "";
