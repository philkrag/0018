...
<title><?php echo "[".$Heading_Index."]"; ?> <?php echo date("Y-m-d"); ?> Milestone Report <?php echo "ID:".$_GET['ID']; ?></title>
</head>
<body onload="">
...
$Display_Array['Display_Items'] = array("ID", "Project ID", "Required Finish Date", "Details", "Status", "Modified By", "Modified Date");
