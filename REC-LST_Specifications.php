...
$Display_Array['Search_Items'] = array("ID", "Equipment ID", "Monitoring Point ID", "Source", "Comments", "Minimum Allowable", "Maximum Allowable", "Unit of Measure", "	Inspection Interval (Days)", "Inspection Monitoring");
...
$Display_Array['Display_Items'] = array("ID", "Equipment ID", "Monitoring Point ID", "Source", "Comments", "Minimum Allowable", "Maximum Allowable", "Unit of Measure", "Inspection Interval (Days)", "Inspection Monitoring");
