...
<title><?php echo "[".$Heading_Index."]"; ?> <?php echo date("Y-m-d"); ?> Controls Report <?php echo "ID:".$_GET['ID']; ?></title>
</head>
<body>
...
$Display_Array['Column_Width'] = array("50px", "200px", "*", "100px", "100px");
$Display_Array['Item_Links'] = "REC_Controls.php";
