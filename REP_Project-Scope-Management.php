...
<title><?php echo "[".$_GET['Project_ID']."]"; ?> Project Scope Management <?php echo "(".$Heading_Index.")" ?> <?php echo date("Y-m-d"); ?></title>
</head>
<body onload="">
...
$Display_Array['Table_Major_Heading'] = "PROJECT SCOPE MANAGEMENT";
...
$Display_Array['IS_Report'] = true;
$Display_Array['New_Page_At_Print'] = false;
$Display_Array['Table_Major_Heading'] = "CHANGE CONTROL(S)";
$Display_Array['Table_Minor_Heading'] = "Details";
...
$Display_Array['Table_Minor_Heading'] = "Impacts";
$Display_Array['Display_Items'] = array("ID",
"Timeline Impact",
"Budget Impact",
"Workplan Impact",
