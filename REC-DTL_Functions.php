...
$Data['Page'] = array("REP_Functions-Diagram");
$Data['Label'] = array("Test");
...
$Display_Array['Table_Major_Heading'] = "FUNCTION";
...
"(L):Design Functionality ID:REC-DTL_Functionality",
"(L):Parent Function ID:REC-DTL_Functions"
);
$Display_Array['Column_Width'] = array("300px", "*" );
$Display_Array['Item_Links'] = "";
...
$Display_Array = null;
$Display_Array['ID'] = $Item_ID;
$Display_Array['Table_Major_Heading'] = "SUB FUNCTION(S)";
...
$Display_Array['New_Link_Reference'] = "Parent Function ID";

$Display_Array['MySQL_Action'] = "SELECT * ";
$Display_Array['MySQL_Table'] = "FROM `rec_functions` ";
$Display_Array['MySQL_Filter'] = "WHERE `Parent Function ID` = ".$Item_ID." AND (`Deleted Date` IS NULL OR `Deleted Date` = '".date("Y-m-d")."') ";
$Display_Array['MySQL_Order'] = ""; 
