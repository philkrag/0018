...
<title><?php echo "[".$_GET['ID']."]"; ?> Task Report (Internal) <?php echo date("Y-m-d"); ?></title>
...
$Display_Array['New_Page_At_Print'] = false;
$Display_Array['Table_Major_Heading'] = null;
$Display_Array['Table_Minor_Heading'] = "Staff";
$Display_Array['Display_Items'] = array(
"(E):Technician ID:reg_contacts:ID:First Name:Technician",
"(E):Technician ID:reg_contacts:ID:Last Name:Technician"
);
$Display_Array['Column_Width'] = array("300px", "*" );
$Display_Array['Item_Links'] = "";
...
$Display_Array['New_Page_At_Print'] = false;
$Display_Array['Table_Major_Heading'] = null;
$Display_Array['Table_Minor_Heading'] = "Dates";
$Display_Array['Display_Items'] = array(
"Identified Date",
