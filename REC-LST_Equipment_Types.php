...
<title>Equipment Types List</title>
</head>
...
$Display_Array['Search_Items'] = array("ID", "Manufacturer", "Manufacturer Range", "Manufacturer Part No", "Division");
...
$Display_Array['Table_Major_Heading'] = "EQUIPMENT TYPE(S)";
$Display_Array['Table_Minor_Heading'] = "";
$Display_Array['Display_Items'] = array("ID", "Manufacturer", "Manufacturer Range", "Manufacturer Part No", "Division");
$Display_Array['Column_Width'] = array("50px", "150px", "150px", "150px", "*");
$Display_Array['Item_Links'] = "REC-DTL_Equipment_Type.php";
