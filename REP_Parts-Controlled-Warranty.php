...
$Display_Array['Table_Major_Heading'] = "CONTROLLED PART(S) - WARRANTY";
...
$Display_Array['MySQL_Filter'] = "WHERE `Warranty Claim Status` = 'Locally Approved' AND (`Deleted Date` IS NULL OR `Deleted Date` = '".date("Y-m-d")."') ";
