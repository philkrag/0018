...
$Display_Array['Search_Items'] = array("ID");
...
$Display_Array['Table_Major_Heading'] = "PART ORDER(S)";
$Display_Array['Table_Minor_Heading'] = "";
$Display_Array['Display_Items'] = array("ID", "Supplier", "Status");
$Display_Array['Column_Width'] = array("50px", "*", "150px");
$Display_Array['Item_Links'] = "REC-DTL_Parts-Order.php";
$Display_Array['New_Link_Reference'] = "Supplier";
