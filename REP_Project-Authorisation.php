...
<title><?php echo "[".$_GET['Project_ID']."]"; ?> Project Authorisation <?php echo "(".$Heading_Index.")" ?> <?php echo date("Y-m-d"); ?></title>
</head>
<body onload="">
...
$Display_Array['Table_Major_Heading'] = "PROJECT AUTHROISATION";
...
$Display_Array['IS_Report'] = true;
$Display_Array['New_Page_At_Print'] = false;
$Display_Array['Table_Major_Heading'] = "CONSTRAINT(S)";
$Display_Array['Table_Minor_Heading'] = "...";
$Display_Array['Display_Items'] = array("ID", "Description");
$Display_Array['Column_Width'] = array("50px", "*");
$Display_Array['Item_Links'] = "";
...
$Display_Array['New_Page_At_Print'] = false;
$Display_Array['Table_Major_Heading'] = "";
$Display_Array['Table_Minor_Heading'] = "Supporting Documentation";
$Display_Array['Display_Items'] = array(
...
$Display_Array['New_Page_At_Print'] = false;
$Display_Array['Table_Major_Heading'] = "";
$Display_Array['Table_Minor_Heading'] = "Approvals";
$Display_Array['Display_Items'] = array(
"Project Managers Approval (Signature + Date)",
"Authorising Managers Approval (Signature + Date)"
);
$Display_Array['Column_Width'] = array("300px", "*" );
$Display_Array['Item_Links'] = "REC_Projects.php";
