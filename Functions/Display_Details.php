...
if($Prefix_Value=="(L)"){ $Prefix_Indicator = true; }
$Label_String = "";
$Link_String = "";
...
switch ($Prefix_Value) {
case "(L)":
// [Indexer]:[Label/Column]:[Page]

$Refined_Data = explode(":", $Display_Array['Display_Items'][$x]);
$Label_String = $Refined_Data[1];
$Link_String = "(<a href=\"".$Refined_Data[2].".php?ID=".$row[$Label_String]."\">Link</a>)";
...
echo "<td class=\"Details_Label_Cell{$Report_CSS_Insert}\">".$Label_String." ".$Link_String."</td>";
