...
// 2020-11-25 	|| Phillip Kraguljac 		|| v1.0
...
$Display_Array['Table_Major_Heading'] = "PROJECTS - CANCELLED";
...
$Display_Array['MySQL_Filter'] = "WHERE `Status` = 'Cancelled' AND (`Deleted Date` IS NULL OR `Deleted Date` = '".date("Y-m-d")."') {$Search_Description} ";
